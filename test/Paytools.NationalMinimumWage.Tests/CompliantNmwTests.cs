...
public class CompliantNmwTests : IClassFixture<NmwEvaluatorFactoryDataFixture>
{
    ...
    public CompliantNmwTests(NmwEvaluatorFactoryDataFixture factoryProviderFixture)
    {

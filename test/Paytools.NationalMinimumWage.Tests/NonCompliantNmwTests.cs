...
public class NonCompliantNmwTests : IClassFixture<NmwEvaluatorFactoryDataFixture>
{
    ...
    public NonCompliantNmwTests(NmwEvaluatorFactoryDataFixture factoryProviderFixture)
    {

...
[assembly: SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1519:Braces should not be omitted from multi-line child statement", Justification = "Bending the rules", Scope = "member", Target = "~M:Payetools.Payroll.Payruns.PayrunEntryProcessord.Process(Payetools.Payroll.Model.IEmployeePayrunInputEntry,Payetools.Payroll.Model.IEmployeePayrunResult@)")]

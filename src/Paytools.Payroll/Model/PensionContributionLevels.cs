...
/// </summary>
public record class PensionContributionLevels : IPensionContributionLevels
{
    /// <summary>
    ...
    /// </summary>
    public decimal? EmployersNiReinvestmentPercentage { get; }

    /// <summary>
    /// Gets any Additional Voluntary Contribution (AVC) on the part of the employee.
    /// </summary>
    public decimal? AvcForPeriod { get; }
    ...
    /// pensionable pay.
    /// </summary>
    public decimal? SalaryForMaternityPurposes { get; }
}